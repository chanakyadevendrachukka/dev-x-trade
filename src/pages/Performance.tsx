...
const Performance = () => {
  ...
  return (
    <PageLayout title="AI Performance Analytics">
      <div className="space-y-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Track your portfolio's performance with AI-powered analytics, smart benchmarking, 
            and predictive performance modeling for data-driven investment decisions.
          </p>
        </div>
