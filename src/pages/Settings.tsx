...
const Settings = () => {
  return (
    <PageLayout title="AI Platform Settings">
      <div className="space-y-6">
        {/* Header */}
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 font-display">
            AI Trading Platform Settings
          </h1>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Configure your AI-powered trading experience, customize predictive algorithms, 
            and manage intelligent notification preferences for optimal trading performance.
          </p>
        </div>
