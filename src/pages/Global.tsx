...
const Global = () => {
  ...
  return (
    <PageLayout title="AI Global Market Intelligence">
      <div className="space-y-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Monitor worldwide markets with AI-powered analytics, cross-border correlation analysis, 
            and intelligent risk assessment across all major global exchanges.
          </p>
        </div>
