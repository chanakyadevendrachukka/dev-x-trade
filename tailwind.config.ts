...
>>>>>>> bba034025d10fce5aae1d9345d32a84c2c98035b
			...
			boxShadow: {
				...
				'glass': '0 8px 32px 0 rgba(31, 38, 135, 0.15), 0 1px 0 rgba(255, 255, 255, 0.1) inset',
				'glow': '0 0 30px hsl(var(--primary-glow) / 0.5), 0 0 60px hsl(var(--primary-glow) / 0.3)',
				'premium': '0 32px 64px -12px rgba(0, 0, 0, 0.25), 0 0 0 1px rgba(255, 255, 255, 0.05) inset',
